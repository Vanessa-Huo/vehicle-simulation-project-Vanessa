 ...
 */
public class Yes extends Effect
{
    /**
    ...
    public Yes (int maxSize, int additionalExplosions){
        this(maxSize);
    ...
    public void act() 
    {
        ...
        if (additionalExplosions > 1){
            ...
            if (Greenfoot.getRandomNumber(5) == 0){
                ...
                getWorld().addObject (new Yes (newSize), getX() + xOffset, getY() + yOffset);
